...
%changelog
* Wed Oct 26 2016 Nick Miller <nick.miller@onyxpoint.com> - 4.1.1-2
...
* Wed Apr 01 2015 Nick Markowski <nmarkowski@keywcorp.com> - 4.1.0-11
- Simp bootstrap ensures the puppetserver service is running before
  running puppet.

* Tue Feb 10 2015 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-10
- Updated the simp 'config' and 'bootstrap' scripts to properly handle the new
  Puppet server and environments.
- Removed requirement on puppet-server
...
* Thu Dec 04 2014 Chris Tessmer <chris.tessmer@onyxpoint.com> - 4.1.0-9
- Backported minor improvements from 5.0.X RC2

* Wed Nov 26 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-8
- Added yum-utils to the list of required packages.

* Tue Nov 25 2014 Chris Tessmer <chris.tessmer@onyxpoint.com> - 4.1.0-8
- Fixed recommendation/current value logic in simp config

* Mon Sep 08 2014 Nick Markowski <nmarkowski@keywcorp.com> - 4.1.0-7
- Simp config now forces ldap sync and bind passwords to be reset on firstrun.

* Mon Jul 21 2014 Nick Markowski <nmarkowski@keyw.corp.com> - 4.1.0-6
- Removed the hiera_config script

* Thu Jul 10 2014 Kendall Moore <kmoore@keywcorp.com> - 4.1.0-6
- Updated configuration items to use more sensible defaults, where possible.

* Tue Jul 08 2014 Nick Markowski <nmarkowski@keywcorp.com> - 4.1.0-5
- Simp config notifies the user if the Puppet CA port is the same as
  the Puppet Masterport, and recommends a change in CA port value.
