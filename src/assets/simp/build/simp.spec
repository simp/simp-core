...
Requires: pupmod-simp-compliance_markup >= 2.4.5, pupmod-simp-compliance_markup < 3.0.0
...
Requires: pupmod-simp-ssh >= 6.8.0, pupmod-simp-ssh < 7.0.0
...
Requires: rubygem-simp-cli >= 5.0.2, rubygem-simp-cli < 6.0.0
