...
Requires: pupmod-herculesteam-augeasproviders_sysctl >= 2.2.0, pupmod-herculesteam-augeasproviders_sysctl < 3.0.0
...
Requires: pupmod-simp-ntpd >= 6.1.1, pupmod-simp-ntpd < 7.0.0
