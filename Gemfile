...
gem 'simp-rake-helpers', ENV.fetch('SIMP_RAKE_HELPERS_VERSION', ['>= 5.8.3', '< 6.0']), git: 'https://github.com/trevor-vaughan/rubygem-simp-rake-helpers.git', branch:  'SIMP-MAINT-fix-asset-check'
