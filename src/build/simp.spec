...
rpm_link_target="/srv/www/yum/`facter operatingsystem`/`facter operatingsystemmajrelease`"
rpm_link="/srv/www/yum/`facter operatingsystem`/`facter operatingsystemrelease`"
...
* Tue Mar 26 2015 Jacob Gingrich <jgingrich@onyxpoint.com> - 4.2.0-Beta
- Updated to Facter 2.4.

* Tue Feb 10 2015 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.2.0-Alpha
...
- Added migration scripts to assist in the upgrade of an existing system to the
  new version supporting Puppet environments

* Mon Dec 15 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-1
...
- The final release of 4.1.0-0

* Mon Sep 08 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-RC3
- Update to RC3 since RC2 had several issues.

* Fri Aug 08 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-RC2
- The next RC of 4.1.0, there are a few minor bugs to work out prior
  to the final release.

* Tue Jun 17 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-RC1
- Updated documentation and created a new version of the simp
  helper application.
