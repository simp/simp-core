...
Requires: pupmod-simp-auditd >= 8.3.2, pupmod-simp-auditd < 9.0.0
...
Requires: pupmod-simp-deferred_resources >= 0.2.1, pupmod-simp-deferred_resources < 1.0.0
...
Requires: pupmod-simp-iptables >= 6.2.2, pupmod-simp-iptables < 7.0.0
...
Requires: rubygem-simp-cli >= 5.0.1, rubygem-simp-cli < 6.0.0
