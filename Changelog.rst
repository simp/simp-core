...
releasing SIMP 6 as the next major release.  Among major changes:
  ...
  * Starting with 6.0.0, the SIMP numbering scheme wil follow Semantic
    Versioning 2.0.0.
...
* Change minimum number of character classes in passwords to **3** from **4**
  per STIG
* Change maximum number of consecutive characters from a given character class
  from **disabled** to **2** per STIG
