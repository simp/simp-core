...
for dir in 'yum' 'ks'; do
  if [ -d "%{_var}/www/${dir}" ]; then
    echo "Warning: ${_var}/www/${dir} exists, not linking to /srv/www/${dir}";
  else
    ln -s "/srv/www/${dir}" "%{_var}/www/${dir}";
  fi
done
...
%changelog
* Thu Oct 13 2016 Nick Markowski <nmarkowski@keywcorp.com> - 4.3.4-0
...
* Fri Apr 10 2015 Chris Tessmer <chris.tessmer@onyxpoint.com> - 4.2.0-1
- Ensured SIMP-ready Puppet environment paths on install as well as upgrade.

* Wed Feb 18 2015 Nick Markowski <nmarkowski@keywcorp.com> - 4.2.0-0
- Added a default simp MCollective hieradata file to include SSL config.

* Fri Feb 06 2015 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.2.0-0
...
* Thu Dec 04 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-9
...
* Thu Nov 13 2014 Kendall Moore <kmoore@keywcorp.com> - 4.1.0-8
- Updated simp-passenger SELinux policy to allow for log rotation and socket file actions

* Mon Aug 25 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-7
- Added a setting to remove the allow virtual package warnings.

* Thu Jul 31 2014 Adam Yohrling <adam.yohrling@onyxpoint.com> - 4.1.0-6
- Removed common::runlevel class inclusion
- Changed common::runlevel::default to just common::runlevel

* Mon Jul 21 2014 Nick Markowski <nmarkowski@keywcorp.com> - 4.1.0-5
- Modified the permissions on the SIMP repos to be apache readable after creation.
...
* Fri Jun 13 2014 Trevor Vaughan <tvaughan@onyxpoint.com> - 4.1.0-3
- Updated the sample puppet.conf.rpmnew file to support directory
