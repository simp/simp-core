...
Requires: pupmod-simp-iptables >= 6.2.0, pupmod-simp-iptables < 7.0.0
...
Requires: pupmod-simp-selinux >= 2.4.0, pupmod-simp-selinux < 3.0.0
Requires: pupmod-simp-simp >= 4.6.0, pupmod-simp-simp < 5.0.0
Requires: pupmod-simp-simplib >= 3.15.0, pupmod-simp-simplib < 4.0.0
