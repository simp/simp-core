...
Requires: pupmod-simp-auditd >= 7.1.0, pupmod-simp-auditd < 9.0.0
...
Requires: pupmod-simp-tftpboot >= 6.4.0 pupmod-simp-tftpboot < 7.0.0
...
Requires: pupmod-simp-libvirt >= 5.4.0
...
Requires: pupmod-simp-simp_grub >= 0.3.0
