...
Name: simp
Version: 6.2.0
Release: Beta2%{?dist}%{?snapshot_release}
...
Requires: pupmod-simp-systemd >= 1.1.1, pupmod-simp-systemd < 2.0.0
...
Requires: pupmod-onyxpoint-gpasswd >= 1.0.5, pupmod-onyxpoint-gpasswd < 2.0.0
...
Requires: pupmod-puppetlabs-motd >= 1.9.0, pupmod-puppetlabs-motd < 2.0.0
...
Requires: pupmod-simp-auditd >= 7.0.0, pupmod-simp-auditd < 9.0.0
...
Requires: pupmod-simp-pupmod >= 7.6.0, pupmod-simp-pupmod < 8.0.0
Requires: pupmod-simp-resolv >= 0.0.1, pupmod-simp-resolv < 1.0.0
Requires: pupmod-simp-rsync >= 6.0.6, pupmod-simp-rsync < 7.0.0
Requires: pupmod-simp-rsyslog >= 7.1.2, pupmod-simp-rsyslog < 8.0.0
...
Requires: pupmod-simp-simplib >= 3.10.0, pupmod-simp-simplib < 4.0.0
...
Requires: simp-environment >= 6.2.9, simp-environment < 7.0.0
