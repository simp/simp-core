...
Requires: pupmod-simp-xinetd >= 3.0.0-2016, pupmod-simp-xinetd < 4.0.0
...
Requires: simp-gpgkeys >= 2.0.0-4%{?dist}.noarch, simp-gpgkeys < 3.0.0
Requires: simp-rsync >= 5.1.0-3%{?dist}.noarch, simp-rsync < 6.0.0
Requires: simp-rsync-clamav >= 5.1.0-3%{?dist}.noarch, simp-rsync-clamav < 6.0.0
