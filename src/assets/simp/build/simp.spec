...
Requires: pupmod-simp-compliance_markup >= 3.0.0, pupmod-simp-compliance_markup < 4.0.0
Requires: pupmod-simp-cron >= 0.1.2, pupmod-simp-cron < 1.0.0
Requires: pupmod-simp-deferred_resources >= 0.2.2, pupmod-simp-deferred_resources < 1.0.0
...
Requires: pupmod-simp-issue >= 0.1.0, pupmod-simp-issue < 1.0.0
...
Requires: pupmod-simp-pupmod >= 7.11.0, pupmod-simp-pupmod < 8.0.0
Requires: pupmod-simp-resolv >= 0.2.0, pupmod-simp-resolv < 1.0.0
Requires: pupmod-simp-rkhunter >= 0.0.2, pupmod-simp-rkhunter < 1.0.0
...
Requires: pupmod-simp-ssh >= 6.8.1, pupmod-simp-ssh < 7.0.0
Requires: pupmod-simp-sssd >= 6.2.0, pupmod-simp-sssd < 7.0.0
Requires: pupmod-simp-stunnel >= 6.5.0, pupmod-simp-stunnel < 7.0.0
...
Requires: pupmod-simp-useradd >= 0.3.0, pupmod-simp-useradd < 1.0.0
Requires: pupmod-simp-vox_selinux >= 1.6.1, pupmod-simp-vox_selinux < 2.0.0
Requires: pupmod-simp-xinetd >= 4.2.0, pupmod-simp-xinetd < 5.0.0
Requires: pupmod-trlinkin-nsswitch >= 2.1.1, pupmod-trlinkin-nsswitch < 3.0.0
Requires: rubygem-simp-cli >= 5.0.3, rubygem-simp-cli < 6.0.0
Requires: rubygem-simp-cli-doc >= 5.0.1, rubygem-simp-cli-doc < 6.0.0
...
Requires: pupmod-simp-autofs >= 6.2.0
Requires: pupmod-simp-dconf >= 0.0.3
Requires: pupmod-simp-freeradius >= 8.0.1
Requires: pupmod-simp-gdm >= 7.2.0
Requires: pupmod-simp-gnome >= 8.1.0
Requires: pupmod-simp-hirs_provisioner >= 0.1.2
Requires: pupmod-simp-ima >= 0.2.0
Requires: pupmod-simp-journald >= 1.1.0
