...
Requires: pupmod-puppet-yum >= 4.1.0, pupmod-puppet-yum < 5.0.0
...
Requires: pupmod-simp-compliance_markup >= 3.1.0, pupmod-simp-compliance_markup < 4.0.0
...
Requires: pupmod-simp-polkit >= 6.2.0, pupmod-simp-polkit < 7.0.0
Requires: pupmod-simp-postfix >= 5.5.0, pupmod-simp-postfix < 6.0.0
Requires: pupmod-simp-pupmod >= 8.0.1, pupmod-simp-pupmod < 9.0.0
...
Requires: pupmod-simp-rsyslog >= 7.6.2, pupmod-simp-rsyslog < 8.0.0
Requires: pupmod-simp-selinux >= 2.5.1, pupmod-simp-selinux < 3.0.0
Requires: pupmod-simp-simp >= 4.11.1, pupmod-simp-simp < 5.0.0
...
Requires: pupmod-simp-simp_firewalld >= 0.1.0, pupmod-simp-simp_firewalld < 1.0.0
Requires: pupmod-simp-simp_openldap >= 6.4.2, pupmod-simp-simp_openldap < 7.0.0
Requires: pupmod-simp-simp_options >= 1.4.0, pupmod-simp-simp_options < 2.0.0
Requires: pupmod-simp-simp_rsyslog >= 0.5.0, pupmod-simp-simp_rsyslog < 1.0.0
Requires: pupmod-simp-ssh >= 6.10.0, pupmod-simp-ssh < 7.0.0
Requires: pupmod-simp-sssd >= 6.3.0, pupmod-simp-sssd < 7.0.0
Requires: pupmod-simp-stunnel >= 6.6.0, pupmod-simp-stunnel < 7.0.0
Requires: pupmod-simp-sudo >= 5.3.0, pupmod-simp-sudo < 6.0.0
Requires: pupmod-simp-sudosh >= 6.2.1, pupmod-simp-sudosh < 7.0.0
Requires: pupmod-simp-svckill >= 3.6.0, pupmod-simp-svckill < 4.0.0
...
Requires: pupmod-simp-tftpboot >= 6.3.0 pupmod-simp-tftpboot < 7.0.0
Requires: pupmod-simp-tlog >= 0.2.0, pupmod-simp-tlog < 1.0.0
Requires: pupmod-simp-upstart >= 6.1.1, pupmod-simp-upstart < 7.0.0
Requires: pupmod-simp-useradd >= 0.4.0, pupmod-simp-useradd < 1.0.0
...
Requires: rubygem-simp-cli >= 6.0.0, rubygem-simp-cli < 7.0.0
Requires: rubygem-simp-cli-doc >= 6.0.0, rubygem-simp-cli-doc < 7.0.0
Requires: simp-adapter >= 1.0.1, simp-adapter < 2.0.0
Requires: simp-selinux-policy >= 1.0.0, simp-selinux-policy < 2.0.0
Requires: simp-environment-skeleton >= 7.1.3, simp-environment-skeleton < 8.0.0
Requires: simp-gpgkeys >= 3.1.1, simp-gpgkeys < 4.0.0
Requires: simp-rsync-skeleton >= 7.0.2, simp-rsync-skeleton < 8.0.0
...
Requires: pupmod-simp-freeradius >= 8.1.0
...
Requires: pupmod-simp-libreswan >= 3.3.0
...
- updated versions for simp modules.
- removed docker from extras
- removed augeasproviders modules from dependency list that were not used by simp:
...
- added pupmod-simp-crypto_policy to the core package list
