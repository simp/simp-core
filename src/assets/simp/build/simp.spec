...
Requires: pupmod-puppetlabs-inifile >= 5.3.0, pupmod-puppetlabs-inifile < 6.0.0
...
Requires: pupmod-simp-aide >= 6.6.0, pupmod-simp-aide < 7.0.0
Requires: pupmod-simp-at >= 0.2.0, pupmod-simp-at < 1.0.0
Requires: pupmod-simp-auditd >= 8.8.0, pupmod-simp-auditd < 9.0.0
Requires: pupmod-simp-clamav >= 6.5.0, pupmod-simp-clamav < 7.0.0
Requires: pupmod-simp-compliance_markup >= 3.2.3, pupmod-simp-compliance_markup < 4.0.0
Requires: pupmod-simp-cron >= 0.3.0, pupmod-simp-cron < 1.0.0
Requires: pupmod-simp-crypto_policy >= 0.2.1, pupmod-simp-crypto_policy < 1.0.0
...
Requires: pupmod-simp-ds389 >= 0.2.0, pupmod-simp-ds389 < 1.0.0
Requires: pupmod-simp-fips >= 0.5.1, pupmod-simp-fips < 1.0.0
Requires: pupmod-simp-haveged >= 0.9.1, pupmod-simp-haveged < 1.0.0
...
Requires: pupmod-simp-postfix >= 5.7.0, pupmod-simp-postfix < 6.0.0
Requires: pupmod-simp-pupmod >= 8.3.1, pupmod-simp-pupmod < 9.0.0
...
Requires: pupmod-simp-simplib >= 4.10.4, pupmod-simp-simplib < 5.0.0
Requires: pupmod-simp-ssh >= 6.13.1, pupmod-simp-ssh < 7.0.0
Requires: pupmod-simp-sssd >= 7.4.1, pupmod-simp-sssd < 8.0.0
Requires: pupmod-simp-stunnel >= 6.7.1, pupmod-simp-stunnel < 7.0.0
Requires: pupmod-simp-sudo >= 5.5.1, pupmod-simp-sudo < 6.0.0
...
Requires: pupmod-trlinkin-nsswitch >= 2.3.0, pupmod-trlinkin-nsswitch < 3.0.0
%if 0%{?rhel} > 7
...
Recommends: simp-vendored-r10k >= 3.14.2, simp-vendored-r10k < 4.0.0
%else
...
Requires: simp-vendored-r10k >= 3.14.2, simp-vendored-r10k < 4.0.0
%endif
...
#  These lines are required for upgrades from 6.6.0 to 6.7.0
#  because these packages have been archived.
Obsoletes: pupmod-simp-chkrootkit <= 0.6.0
Obsoletes: pupmod-simp-hirs_provisioner <= 0.5.1
Obsoletes: pupmod-simp-incron <= 0.11.0
Obsoletes: pupmod-simp-network <= 6.7.0
Obsoletes: pupmod-simp-rkhunter <= 0.5.0
Obsoletes: pupmod-simp-simp_ipa <= 0.4.2
Obsoletes: pupmod-simp-simp_openldap <= 6.11.1
Obsoletes: pupmod-simp-sudosh <= 6.5.0
Obsoletes: pupmod-simp-tcpwrappers <= 6.5.0
Obsoletes: pupmod-simp-tpm <= 3.5.3
Obsoletes: pupmod-simp-xinetd <= 4.8.2
...
Requires: pupmod-simp-dconf >= 0.2.2
Requires: pupmod-simp-freeradius >= 8.2.0
Requires: pupmod-simp-gdm >= 7.4.1
...
Requires: pupmod-simp-mate >= 1.3.0
...
Requires: pupmod-simp-simp_snmpd >= 1.1.1
